...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('РегРезультE', 'i-i-s-kandidaty-na-rabotu-рег-результ', {
    ...
    планирСобес: belongsTo('i-i-s-kandidaty-na-rabotu-планир-собес', 'ФИО кандидата', {
      иметьПриСебе: attr('ФИО кандидата', { index: 2, hidden: true }),
    ...
    организация: belongsTo('i-i-s-kandidaty-na-rabotu-организация', 'Наименование организации', {
      наименование: attr('Наименование организации', { index: 5, hidden: true })
    }, { index: 4, displayMemberPath: 'наименование' }),
    приглНаРаб: attr('Приглашен на работу', { index: 6 }),
    кандидОтклон: attr('Кандидатура отклонена', { index: 7 }),
  ...
  modelClass.defineProjection('РегРезультL', 'i-i-s-kandidaty-na-rabotu-рег-результ', {
    датРегРезСобес: attr('Дата регистрации результатов собеседования', { index: 0 }),
    планирСобес: belongsTo('i-i-s-kandidaty-na-rabotu-планир-собес', 'ФИО кандидата', {
      иметьПриСебе: attr('ФИО кандидата', { index: 1 }),
      регистАнкеты: belongsTo('i-i-s-kandidaty-na-rabotu-регист-анкеты', '', {
        вакантДолжн: belongsTo('i-i-s-kandidaty-na-rabotu-вакант-должн', '', {
          должность: attr('Вакантная должность', { index: 2 })
        }, { index: -1, hidden: true })
      }, { index: -1, hidden: true })
    }, { index: -1, hidden: true }),
    организация: belongsTo('i-i-s-kandidaty-na-rabotu-организация', 'Наименование организации', {
      наименование: attr('Наименование организации', { index: 3 })
    }, { index: -1, hidden: true }),
    приглНаРаб: attr('Приглашен на работу', { index: 4 }),
    кандидОтклон: attr('Кандидатура отклонена', { index: 5 })
  });
};
