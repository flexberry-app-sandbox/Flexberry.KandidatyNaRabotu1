...
define('ember-app/mixins/regenerated/models/i-i-s-kandidaty-na-rabotu-\u0440\u0435\u0433-\u0440\u0435\u0437\u0443\u043B\u044C\u0442', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('РегРезультE', 'i-i-s-kandidaty-na-rabotu-рег-результ', {
      ...
      планирСобес: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-планир-собес', 'ФИО кандидата', {
        иметьПриСебе: (0, _attributes.attr)('ФИО кандидата', { index: 2, hidden: true }),
        регистАнкеты: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-регист-анкеты', '', {
          вакантДолжн: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-вакант-должн', '', {
            должность: (0, _attributes.attr)('Вакантная должность', { index: 3 })
          }, { index: -1, hidden: true })
        }, { index: -1, hidden: true })
      }, { index: 1, displayMemberPath: 'фИОКандид' }),
      организация: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-организация', 'Наименование организации', {
        наименование: (0, _attributes.attr)('Наименование организации', { index: 5, hidden: true })
      }, { index: 4, displayMemberPath: 'наименование' }),
      приглНаРаб: (0, _attributes.attr)('Приглашен на работу', { index: 6 }),
      кандидОтклон: (0, _attributes.attr)('Кандидатура отклонена', { index: 7 }),
    ...
    modelClass.defineProjection('РегРезультL', 'i-i-s-kandidaty-na-rabotu-рег-результ', {
      датРегРезСобес: (0, _attributes.attr)('Дата регистрации результатов собеседования', { index: 0 }),
      планирСобес: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-планир-собес', 'ФИО кандидата', {
        иметьПриСебе: (0, _attributes.attr)('ФИО кандидата', { index: 1 }),
        регистАнкеты: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-регист-анкеты', '', {
          вакантДолжн: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-вакант-должн', '', {
            должность: (0, _attributes.attr)('Вакантная должность', { index: 2 })
          }, { index: -1, hidden: true })
        }, { index: -1, hidden: true })
      }, { index: -1, hidden: true }),
      организация: (0, _attributes.belongsTo)('i-i-s-kandidaty-na-rabotu-организация', 'Наименование организации', {
        наименование: (0, _attributes.attr)('Наименование организации', { index: 3 })
      }, { index: -1, hidden: true }),
      приглНаРаб: (0, _attributes.attr)('Приглашен на работу', { index: 4 }),
      кандидОтклон: (0, _attributes.attr)('Кандидатура отклонена', { index: 5 })
    });
  };
});
